...
// lifecycle events for the same resource converge to the same final state
// without any targeted key deletion.
...
/**
 * Maps a lifecycle event to its cache effect. Folder and metadata visibility
 * transitions all bump the same org-wide asset epoch, since
